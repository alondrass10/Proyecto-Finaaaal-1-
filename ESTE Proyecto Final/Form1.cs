...
namespace Proyecto_Final_2020
{
    public partial class Form1 : Form
    {
        ...
        {
            // TODO: esta línea de código carga datos en la tabla 'alondraDataSet1.provedores' Puede moverla o quitarla según sea necesario.
            this.provedoresTableAdapter.Fill(this.alondraDataSet1.provedores);
        ...
        private void btnProveedor_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtProvProd.Text == string.Empty)
                {
                    MessageBox.Show("Debe ingresar el nombre del producto");
                    txtDescripcion.Focus();
                    return;
                ...
                double precio = 0;
                if (!double.TryParse(txtPago.Text, out precio))
                {
                    MessageBox.Show("Ingrese el pago adecuadamente.\nNOTA: Solo números");
                    txtPrecio.Focus();
                    return;
                }
                if (precio <= 0)
                ...
                Proveedores miProv = new Proveedores();
                miProv.Nombre = txtNombre.Text;
                miProv.RFC = txtRFC.Text;
                miProv.Producto = txtProvProd.Text;
                

                MessageBox.Show(conexion.insertar(miProv.RFC, miProv.Nombre, miProv.Producto, miProv.Precio));
                this.provedoresTableAdapter.Fill(this.alondraDataSet1.provedores);
        ...
        {
            MessageBox.Show(conexion.eliminar(txtRFC.Text));
